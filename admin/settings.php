...
<<<<<<< HEAD
        <div class="page-header">
            <div>
                ...
                <p>Manage company profile, security, and subscription tier.</p>
            </div>
=======
...
>>>>>>> 8a31c97ebc09cdc33ce8bdd186d7409462b2a93a
        ...
        <div class="grid-2col">
            <!-- Company Profile -->
            <div class="form-card">
                <h3>Tenant Profile Information</h3>
                <form method="POST">
                    ...
                    <div class="form-group" style="margin-bottom:16px;">
                        <label>Tenant Username (Permanent)</label>
                        <input type="text" value="<?php echo htmlspecialchars($tenant['username'] ?? ''); ?>" disabled>
                    </div>

                    <div class="form-group" style="margin-bottom:16px;">
                        <label>Billing / Admin Email</label>
