    ...
    <div class="sa-card-foot">
        <div class="sa-pagination">
            ...
            <?php if ($filter_page < $total_pages): ?>
                <a href="?page=<?php echo $filter_page + 1; ?>&portal=<?php echo urlencode($filter_portal); ?>&action=<?php echo urlencode($filter_action); ?>&user=<?php echo urlencode($filter_user); ?>&start=<?php echo urlencode($filter_start); ?>&end=<?php echo urlencode($filter_end); ?>" class="sa-btn sa-btn-sm sa-btn-ghost">Next <?php echo sa_icon('arrow-left'); ?></a>
            <?php endif; ?>
        </div>
    </div>
    <?php endif; ?>
